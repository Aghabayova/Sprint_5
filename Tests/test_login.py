...
class TestLogin:
    ...
    def test_login_from_user_account_success(self, driver):
        driver.get(URLS["base"])
    ...
    def test_login_from_registration_form_success(self, driver):
        ...
        driver.find_element(*LoginPageLocators.LOGIN_BUTTON_FROM_REGISTRATION_FORM).click()
    ...
    def test_login_from_recover_password_form_success(self, driver):
        driver.get(URLS["base"] + URLS['restore_password'])

        driver.find_element(*LoginPageLocators.LOGIN_BUTTON_FROM_RESTORE_PASSWORD_FORM).click()
